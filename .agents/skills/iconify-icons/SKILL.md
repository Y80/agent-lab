...
Read [references/iconify-implementation.md](references/iconify-implementation.md) when you need concrete install commands, code snippets, Tailwind setup, Web Component setup, CSS masks/backgrounds, offline usage, or official documentation links.
